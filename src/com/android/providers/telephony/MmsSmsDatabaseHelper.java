...
public class MmsSmsDatabaseHelper extends SQLiteOpenHelper {
    ...
    private void createMmsTables(SQLiteDatabase db) {
        ...
        /*Begin: Modified by vicent for MSG_NETWORKTYPE 2012/06/04*/
        ...
        db.execSQL("CREATE TABLE " + MmsProvider.TABLE_PDU + " (" +
                   ...
                   Mms.SEEN + " INTEGER DEFAULT 0," +
                   Mms.SUB_ID + " INTEGER DEFAULT 0," +
                   Mms.NETWORKTYPE_ID + " INTEGER DEFAULT 0" +
                   ");");
        /*End: Modified by vicent for MSG_NETWORKTYPE 2012/06/04*/
    ...
    private void createSmsTables(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE sms (" +
                   ...
                   "sub_id INTEGER DEFAULT 0," +   // sub_id : 0 for subscription 1
                                                   // sub_id : 1 for subscription 2
                   "networktype_id INTEGER DEFAULT 0," +
                   "error_code INTEGER DEFAULT 0," +
                   "seen INTEGER DEFAULT 0" +
                   ");");
        /*End: Modified by vicent for MSG_NETWORKTYPE 2012/06/04*/
