...
public class TelephonyProvider extends ContentProvider
{
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private void initDatabase(SQLiteDatabase db) {
            /*ren_kang.hoperun 2012.8.8 add a flag:in China gsmApnEnable is false, else it is true*/
            /*In system.prop it is false*/
            boolean gsmApnEnable = SystemProperties.getBoolean("ro.ril.gsm.apn.enable", true);
            // Read internal APNS data
            Resources r = mContext.getResources();
            XmlResourceParser parser;
            if (!gsmApnEnable) {
                parser = r.getXml(com.android.internal.R.xml.apns);
            }
            else {
                parser = r.getXml(com.android.internal.R.xml.apns_out_cn);//apns_out_cn.xml contains 46000,46001,46002,46007
            }
            int publicversion = -1;
            try {
                XmlUtils.beginDocument(parser, "apns");
    ...
    private void setPreferredApnId(Long id) {
        ...
        /*ren_kang.hoperun 20120801 change the default value -1 to 8(the ID of ctnet)*/
        /*ren_kang.hoperun 20120806 add getDefaultApnLong() better*/
        editor.putLong(COLUMN_APN_ID, id != null ? id.longValue() : getDefaultApnLong());
        /*ren_kang.hoperun end*/
        /*ren_kang.hoperun 20120801 end*/
        editor.apply();
    }
    ...
    private long getPreferredApnId() {
        ...
        /*ren_kang.hoperun 20120801 change the default value -1 to 8(the ID of ctnet)*/
        /*ren_kang.hoperun 20120806 add getDefaultApnLong() better*/
        return sp.getLong(COLUMN_APN_ID, getDefaultApnLong());
        /*ren_kang.hoperun 20120806 end*/
        /*ren_kang.hoperun 20120801 end*/
    }
    ...
    /*ren_kang.hoperun 20120806 add getDefaultApnLong() better*/
    private long getDefaultApnLong(){
        Uri uri =Uri.parse("content://telephony/carriers");
        String where = "numeric=\""+"46003\""+" and type <> \""+"mms\"";
        Cursor cursor = this.getContext().getContentResolver().query(
                uri, null, where, null, null);
        if (cursor != null)
        {
            cursor.moveToFirst();
            long defaultApn = cursor.getLong(cursor.getColumnIndex("_id"));
            cursor.close();
            return defaultApn;
        }
        else {
